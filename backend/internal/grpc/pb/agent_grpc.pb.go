...
const (
	AgentService_Register_FullMethodName     = "/sharedgpu.agent.v1.AgentService/Register"
	AgentService_Heartbeat_FullMethodName    = "/sharedgpu.agent.v1.AgentService/Heartbeat"
	AgentService_StreamJobs_FullMethodName   = "/sharedgpu.agent.v1.AgentService/StreamJobs"
	AgentService_ReportResult_FullMethodName = "/sharedgpu.agent.v1.AgentService/ReportResult"
)
...
type AgentServiceClient interface {
	...
	StreamJobs(ctx context.Context, in *StreamJobsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[JobPayload], error)
...
func (c *agentServiceClient) StreamJobs(ctx context.Context, in *StreamJobsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[JobPayload], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AgentService_ServiceDesc.Streams[0], AgentService_StreamJobs_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamJobsRequest, JobPayload]{ClientStream: stream}
...
type AgentService_StreamJobsClient = grpc.ServerStreamingClient[JobPayload]

func (c *agentServiceClient) ReportResult(ctx context.Context, in *JobResult, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
...
type AgentServiceServer interface {
	...
	StreamJobs(*StreamJobsRequest, grpc.ServerStreamingServer[JobPayload]) error
...
func (UnimplementedAgentServiceServer) StreamJobs(*StreamJobsRequest, grpc.ServerStreamingServer[JobPayload]) error {
	return status.Error(codes.Unimplemented, "method StreamJobs not implemented")
}
func (UnimplementedAgentServiceServer) ReportResult(context.Context, *JobResult) (*Ack, error) {
...
func _AgentService_StreamJobs_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AgentServiceServer).StreamJobs(m, &grpc.GenericServerStream[StreamJobsRequest, JobPayload]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentService_StreamJobsServer = grpc.ServerStreamingServer[JobPayload]
...
func _AgentService_ReportResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).ReportResult(ctx, req.(*JobResult))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sharedgpu.agent.v1.AgentService",
