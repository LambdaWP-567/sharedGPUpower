...
func (x *ICESignal) GetFromAgentId() string {
	if x != nil {
...
func (x *ICESignal) GetToAgentId() string {
	if x != nil {
		return x.ToAgentId
	}
	return ""
...
func (x *ICESignal) GetJobId() string {
	if x != nil {
		return x.JobId
	}
	return ""
...
func (x *ICESignal) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ICESignal) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
const file_signaling_proto_rawDesc = "" +
	"\n" +
	"\x0fsignaling.proto\x12\x16sharedgpu.signaling.v1\"\x94\x01\n" +
	"\tICESignal\x12\"\n" +
	"\rfrom_agent_id\x18\x01 \x01(\tR\vfromAgentId\x12\x1e\n" +
	"\vto_agent_id\x18\x02 \x01(\tR\ttoAgentId\x12\x15\n" +
	"\x06job_id\x18\x03 \x01(\tR\x05jobId\x12\x12\n" +
	"\x04type\x18\x04 \x01(\tR\x04type\x12\x18\n" +
	"\apayload\x18\x05 \x01(\fR\apayload2h\n" +
	"\x10SignalingService\x12T\n" +
	"\bExchange\x12!.sharedgpu.signaling.v1.ICESignal\x1a!.sharedgpu.signaling.v1.ICESignal(\x010\x01BAZ?github.com/lambdawp-567/sharedgpupower/backend/internal/grpc/pbb\x06proto3"
...
var file_signaling_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_signaling_proto_goTypes = []any{
	(*ICESignal)(nil), // 0: sharedgpu.signaling.v1.ICESignal
}
var file_signaling_proto_depIdxs = []int32{
	0, // 0: sharedgpu.signaling.v1.SignalingService.Exchange:input_type -> sharedgpu.signaling.v1.ICESignal
	0, // 1: sharedgpu.signaling.v1.SignalingService.Exchange:output_type -> sharedgpu.signaling.v1.ICESignal
